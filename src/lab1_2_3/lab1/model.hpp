...
typedef RandomGenerator<std::geometric_distribution<>, double> GeometricGenerator;
typedef RandomGenerator<std::poisson_distribution<>, double> PoissonGenerator;
typedef RandomGenerator<std::lognormal_distribution<>, double, double> LogonormalGenerator;

typedef RandomGenerator<std::normal_distribution<>, double, double> NormalGenerator;
typedef RandomGenerator<std::exponential_distribution<>, double> ExponentialGenerator;
typedef RandomGenerator<std::chi_squared_distribution<>, double> ChiSquareGenerator;
typedef RandomGenerator<std::student_t_distribution<>, double> StudentGenerator;
