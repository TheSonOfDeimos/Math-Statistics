...
void ExelWriter::addSummary(int n, double expectation, double dispercion)
{
    ...
    wks.Cell(wks.RowCount(), 4).Value() = dispercion;
}
...
void ExelWriter::initTables()
{
    ...
    auto wks = doc_.Workbook().Worksheet("Summary");
    wks.Cell("A1").Value() = "N";
    wks.Cell("B1").Value() = "Expectation experimental";
    wks.Cell("C1").Value() = "Expectation theoretical";
    wks.Cell("D1").Value() = "Dispersion experimental";
    wks.Cell("E1").Value() = "Dispersion theoretical";
